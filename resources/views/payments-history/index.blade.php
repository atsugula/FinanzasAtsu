                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('payments-histories.destroy', $paymentsHistory->id) }}" method="POST" class="form-delete">
                                                    <a class="btn btn-sm btn-primary" href="{{ route('payments-histories.show', $paymentsHistory->id) }}">
                                                        <i class="fa fa-fw fa-eye"></i> {{ __('Show') }}
                                                    </a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('payments-histories.edit', $paymentsHistory->id) }}">
                            ...
                            <br>
                            {{ $paymentsHistories->appends(request()->except('page'))->links('vendor.pagination.custom') }}
                        </div>
                    </div>
                </div>
            </div>
