<div class="box box-info padding-1">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    {{ Form::text('category', $expense->expensesCategory?->name, ['class' => 'form-control' . ($errors->has('category') ? ' is-invalid' : ''), 'disabled' => 'disabled', 'placeholder' => 'Category']) }}
            ...
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    {{ Form::text('status_expense', $expense->statuse?->name, ['class' => 'form-control' . ($errors->has('status_expense') ? ' is-invalid' : ''), 'disabled' => 'disabled', 'placeholder' => 'Status']) }}
            ...
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    {{ Form::text('amount', $expense->amount, ['class' => 'form-control' . ($errors->has('amount') ? ' is-invalid' : ''), 'id' => 'amount', 'disabled' => 'disabled', 'placeholder' => 'Amount']) }}
            ...
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    {{ Form::date('date_expense', $expense->date, ['class' => 'form-control' . ($errors->has('date_expense') ? ' is-invalid' : ''), 'disabled' => 'disabled', 'placeholder' => 'Date']) }}
            ...
            <div class="col-12 col-md-12">
                <div class="form-group">
                    ...
                    {{ Form::textArea('description', $expense->description, ['class' => 'form-control' . ($errors->has('description') ? ' is-invalid' : ''), 'disabled' => 'disabled', 'placeholder' => 'Description']) }}
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-4">
                <div class="form-group">
                    ...
                    {{ Form::text('payable', $balance['balance_due'], ['class' => 'form-control' . ($errors->has('payable') ? ' is-invalid' : ''), 'id' => 'payable', 'disabled' => 'disabled', 'placeholder' => 'Payable']) }}
    ...
    {{ Form::text('expense_id', $expense->id, ['class' => 'form-control' . ($errors->has('payable') ? ' is-invalid' : ''), 'hidden' => 'hidden', 'placeholder' => 'Payable']) }}
