        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    {{ Form::number('document_number', $partner->document_number, ['class' => 'form-control' . ($errors->has('document_number') ? ' is-invalid' : ''), 'placeholder' => 'Document Number']) }}
            ...
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    {{ Form::text('company_name', $partner->company_name, ['class' => 'form-control' . ($errors->has('company_name') ? ' is-invalid' : ''), 'placeholder' => 'Company Name']) }}
            ...
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    {{ Form::number('phone', $partner->phone, ['class' => 'form-control' . ($errors->has('phone') ? ' is-invalid' : ''), 'placeholder' => 'Phone']) }}
            ...
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    {{ Form::email('email', $partner->email, ['class' => 'form-control' . ($errors->has('email') ? ' is-invalid' : ''), 'placeholder' => 'Email']) }}
